...
height = 64;
width = 64;
# I crop the image and resize it. This was done on all the inputs during the training process( training set, validation set and test set)
def make_roi(image):
...
def telemetry(sid, data):
    ...
    image_array = make_roi(image_array)
